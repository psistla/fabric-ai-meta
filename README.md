...
![Version](https://img.shields.io/badge/version-1.7.0-238636?style=flat-square)
![Tests](https://img.shields.io/badge/tests-558%20passing-1a7f37?style=flat-square)
...
| `export` | `langchain`, `openai`, `semantic-kernel`, `autogen`, `prep-for-ai`, `copilot`, or [your own plugin](#custom-exporters) |
...
New exporters ship as [plugins](#custom-exporters) rather than PRs here. Fixture models under `tests/fixtures/` and doc fixes are the easiest first contributions.
